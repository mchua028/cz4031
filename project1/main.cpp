...
int main() {
    ...
    if(dataFile.is_open()) {
        ...
        while (getline(dataFile, line)) {
            ...
            // @Ryan: Uncomment to view insertion, currently commenting it out because the data size is too huge, can try this with a file with smaller data size
            
            // cout <<"Inserted: " << record.tconst << " Average Rating: " << record.averageRating <<" Num Votes: " << record.numVotes<< endl;
